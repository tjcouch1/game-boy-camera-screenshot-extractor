...
const REMOTE_SHEETS: SheetEntry[] = [
  {
...
function main() {
  ...
  // Merge remote sheets.
  const allSheetEntries = [...sheetEntries, ...REMOTE_SHEETS];
  allSheetEntries.sort((a, b) => a.stem.localeCompare(b.stem));
  ...
  const entries = [...allSheetEntries, ...individualEntries];
